...
//lpm_constant CBX_AUTO_BLACKBOX="ALL" ENABLE_RUNTIME_MOD="NO" LPM_CVALUE=000124F8 LPM_WIDTH=32 result
...
module  CONSTANT_75000_lpm_constant_039
	( 
	result) ;
	output   [31:0]  result;
	...
	assign
		result = 32'b00000000000000010010010011111000;
endmodule //CONSTANT_75000_lpm_constant_039
//VALID FILE
...
module CONSTANT_75000 (
	...
	CONSTANT_75000_lpm_constant_039	CONSTANT_75000_lpm_constant_039_component (
				.result (sub_wire0));
